...
// con nome comune "selection
	...
	// costruzione hidden field che ci servirà nella zona aggiungiCarrello per ottenere il nome del film e della categoria
		...
		$elenco.="<input type=\"hidden\" name=\"dbCategoria\" value=\"$VOmovie_poliziesco_table\"> </td> \n </form>\n";
		$counter++;
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<h1 style=" text-align: center; color: #FDEBD0; margin-top: 20px " >Crime movies </h1>
	
	<p style="text-align: center;color:white">
        	Film polizieschi disponibili nel nostro store. Cliccando sulla copertina del film potrai effettuarne l'acquisto.
    </p>
